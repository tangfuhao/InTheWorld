...
signal message_dispatch(_message_dic)
signal message_dispatch2(_player_node,_message_dic)
...
func send_message_to_subscriber(_player,_message_dic):
	emit_signal("message_dispatch",_message_dic)
	emit_signal("message_dispatch2",_player,_message_dic)
...
func send_player_action(_player,_action,_target):
	...
	send_message_to_subscriber(_player,message_dic)
